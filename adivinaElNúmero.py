	...
	def juego(self):
		...
		while intentosRealizados < 6:
			...
			if estimación < número:
				print(f"Tu estimacion es muy baja.(te quedan {intentos} intentos)") # Hay ocho espacios delante de print.
				intentos = intentos - 1
		...
		if estimación == número:
			...
			print(f"¡Buen trabajo, {self.miNombre}! ¡Has adivinado mi número en {intentosRealizados} intentos!")
