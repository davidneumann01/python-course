...
class Aplicacion:
    ...
    def entradadatos(self):
        ...
        self.boton1 = ttk.Button(
            self.lf1, text="Generar grafico", command=self.grafico_tarta
        )
    ...
    def grafico_tarta(self):
        ...
        self.canvas1.create_arc(
            10, 10, 400, 400, fill="blue", start=grados1, extent=grados2
        )
        self.canvas1.create_arc(
            10, 10, 400, 400, fill="yellow", start=grados1 + grados2, extent=grados3
        )
        self.canvas1.create_text(
            500, 50, text="parido A:" + str(valor1), fill="red", font="Arial"
        )
        self.canvas1.create_text(
