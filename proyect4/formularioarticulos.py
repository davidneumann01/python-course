...
class FormularioArticulos:
    ...
    def consultar(self):
        ...
        if len(respuesta) > 0:
            ...
            self.precio.set("")
            mb.showinfo("Información", "No existe un articulo con dicho código")
    ...
    def listado_completo(self):
        ...
        self.scrolledtext1 = st.ScrolledText(self.labelframe3, width=30, heigh=10)
    ...
    def modificar(self):
        ...
        self.entrydescripcion = ttk.Entry(
            self.labelframe5, textvariable=self.descripcionmod
        )
        self.entrydescripcion.grid(column=1, row=1, padx=4, pady=4)
        ...
        self.entryprecio.grid(column=1, row=2, padx=4, pady=4)
        self.boton1 = ttk.Button(
            self.labelframe5, text="Consultar", command=self.consultar_mod
        )
        self.boton1.grid(column=1, row=3, padx=4, pady=4)
        self.boton1 = ttk.Button(
            self.labelframe5, text="Modificar", command=self.modifica
        )
