...
class Aplicacion:
    def __init__(self):
        ...
        self.canvas1 = tk.Canvas(
            self.ventana2, width=600, height=400, background="black"
        )
    ...
    def entradadatos(self):
        ...
        self.boton1 = ttk.Button(
            self.lf1, text="Generar grafico", command=self.grafico_barraporcentual
        )
    ...
    def grafico_barraporcentual(self):
        ...
        self.canvas1.create_text(
            50, 220, text="{0:.2f}".format(porc1) + "%", fill="white", font="Arial"
        )
