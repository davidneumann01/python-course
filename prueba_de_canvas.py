...
class Aplicacion:
    ...
    def canvas(self):
        ...
        self.canvas1 = tk.Canvas(
            self.ventana1, width=600, height=400, background="black"
        )
        ...
        self.canvas1.create_rectangle(
            100, 300, 150, 350, fill="#aaaaaa", tag="cuadrado"
        )
        self.canvas1.create_rectangle(
            200, 300, 250, 350, fill="#555555", tag="cuadrado"
        )
        self.canvas1.create_rectangle(
            300, 300, 350, 350, fill="#cccccc", tag="cuadrado"
        )
    ...
    def crear_botones(self):
        ...
        self.boton1 = ttk.Button(
            self.labelframe1, text="borrar linea", command=self.borrar_linea
        )
        self.boton1.grid(column=0, row=0, padx=5)
        self.boton2 = ttk.Button(
            self.labelframe1, text="borrar rectángulo", command=self.borrar_rectangulo
        )
        self.boton2.grid(column=1, row=0, padx=5)
        self.boton3 = ttk.Button(
            self.labelframe1, text="borrar óvalo", command=self.borrar_ovalo
        )
        self.boton3.grid(column=2, row=0, padx=5)
        self.boton4 = ttk.Button(
            self.labelframe1,
            text="borrar todos los cuadrados",
            command=self.borrar_cuadrados,
        )
        self.boton4.grid(column=3, row=0, padx=5)
        self.boton5 = ttk.Button(
            self.labelframe1, text="borrar todos", command=self.borrar_todos
        )
        self.boton5.grid(column=4, row=0, padx=5)
        self.boton6 = ttk.Button(
            self.labelframe1, text="Regresar todos", command=self.recuperar_todo
        )
        self.boton6.grid(column=5, row=0, padx=5)
